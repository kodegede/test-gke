...
1.  Add the following [Cloud IAM roles][roles] to your service account:
    ...
    **Note**: _These permissions are overly broad to favor a quick start. They do not
    ...
    restrictive permissions._

1.  [Create a JSON service account key][create-key] for the service account.

    **Note**: _You won't require this if you are using [self-hosted runners](https://docs.github.com/en/actions/hosting-your-own-runners/about-self-hosted-runners)_
